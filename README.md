...
**[▶ See it in action](https://n1crack.github.io/subset-finder/)** — three real use cases with output captured from the actual package (the page is generated by `php docs/build.php`).
